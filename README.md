# Gourmand
A utility mod library for improved handling of certain server-side content on the client-side.
...
just a few days before Chrunchy Christmas 2025 had started.

## Is the name inspired by Rain World?
I was going through some synonyms for "crunch" and "munch", then found synonyms for eating partner,
then found "gourmand" and thought about the Rain World character. So the icon is based on them.
